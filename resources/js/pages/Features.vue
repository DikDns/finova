    ...
    <div class="flex min-h-screen flex-col">
        ...
        <section class="bg-white py-16">
            <div class="container mx-auto space-y-6 px-4 text-center sm:px-6 md:px-12">
                <h1 class="text-foreground font-serif text-4xl leading-tight font-bold sm:text-5xl md:text-6xl">Fitur Andalan Kami</h1>
                <p class="mb-12 text-gray-600">Fitur yang bikin keuanganmu lebih teratur dan terkontrol.</p>

                <!-- Carousel Section -->
                <Carousel :opts="{ loop: true }" class="mx-auto w-full max-w-4xl">
                    <CarouselContent>
                        <CarouselItem>
                    ...
                    <div class="mt-8 flex justify-center gap-4">
                        <CarouselPrevious class="bg-muted text-foreground rounded-full border" />
                        <CarouselNext class="bg-muted text-foreground rounded-full border" />
                    </div>
                </Carousel>
            </div>
        </section>
