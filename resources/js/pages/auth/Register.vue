...
<template>
    <div class="flex h-screen w-screen flex-col bg-[#f0f4f8] md:flex-row">
        ...
        <div class="flex w-full items-center justify-center bg-[#ffffff] p-4 md:w-1/2 md:pt-50 md:pr-0 md:pb-50 md:pl-0">
            <div class="w-full max-w-lg p-8 shadow-2xl rounded-2xl items-center justify-center flex-row md:bg-transparent md:rounded-0 md:shadow-none md:p-0">
                <h1 class="py-5 text-center text-3xl text-[#000000] md:text-4xl md:px-5 sm:text-3xl">Atur keuanganmu sekarang!</h1>
