                        ...
                        <AccordionItem v-for="group in groupedCategories" :key="group.id" :value="group.id" class="border-0 border-b">
                            <AccordionTrigger class="hover:bg-muted/50 px-6 py-3 hover:no-underline">
                                <div class="grid w-full grid-cols-4 gap-4">
                                    ...
                                    <div class="text-right font-medium">{{ formatCurrency(group.totalAllocated) }}</div>
                                    <div class="text-right font-medium text-red-500">{{ formatCurrency(group.totalSpent) }}</div>
                                    <div class="text-right font-medium">{{ formatCurrency(group.totalTarget) }}</div>
                                </div>
                            </AccordionTrigger>
